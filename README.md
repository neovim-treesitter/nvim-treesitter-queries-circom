# nvim-treesitter-queries-circom

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-circom/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-circom/actions/workflows/validate.yml)

Neovim tree-sitter queries for **circom**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-circom",
...
- [ ] Changes are scoped to `circom` — do not include files for other languages
